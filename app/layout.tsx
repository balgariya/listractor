...
export const metadata = {
  title: "Листрактор",
  description: "ПДФ екстрактор за листовки",
  icons: {
    icon: "/favicon.ico",
  },
};
            ...
            <footer className="w-full flex flex-col items-center justify-center py-3 gap-2">
              <div className="flex items-center gap-3">
                <Link
                  ...
                  href="https://github.com/balgariya/listractor">
                  <span className="text-default-600">Гитхаб репозитори</span>
                </Link>
                ...
                <Link
                  ...
                  <span className="text-default-600">Ела в нашия Дискорд</span>
                </Link>
              </div>
